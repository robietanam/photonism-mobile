...
class PostPopulerPageView extends ConsumerStatefulWidget {
  PostPopulerPageView({
    super.key,
    required this.user,
  });
  ...
  @override
  ConsumerState<PostPopulerPageView> createState() => _PostPageViewState();
}

class _PostPageViewState extends ConsumerState<PostPopulerPageView> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ref
          .read(postsPopulerNotifierProvider.notifier)
          .getPostsPopuler(user: user);
    });
  ...
  Widget build(BuildContext context) {
    ref.watch(postsPopulerNotifierProvider).maybeWhen(
      orElse: () {
        _isLoading = false;
    ...
    return RefreshIndicator(
      onRefresh: () async {
        setState(() {
          ...
          ref
              .watch(postsPopulerNotifierProvider.notifier)
              .getPostsPopuler(user: user);
        });
      },
      child: Padding(
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: TextJudul(
                  text: 'Top 10 postingan dengan jumlah like terbanyak',
          ...
          children: [
            Row(
              ...
              children: [
                Row(
                  children: [
                    AvatarUserIcon(imageLink: user.profileImage),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Column(
